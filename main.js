...
(function(){'use strict';const o$1=()=>{},r=()=>true,e$2=()=>false;Promise.resolve();new Promise(o$1);/* eslint-disable no-restricted-globals -- logger */ const consoleLog = unsafeWindow.console.log;
    ...
    any () {
        ((origCanPlayType)=>{
            ...
            HTMLMediaElement.prototype.canPlayType = function(type) {
                logger.log('HTMLVideoElement.prototype.canPlayType called with', {
                    type
                });
        ...
        ((origIsTypeSupported)=>{
            ...
            unsafeWindow.MediaSource.isTypeSupported = function(type) {
                logger.log('MediaSource.isTypeSupported called with', {
                    type
                });
                if (type.includes('av01')) {
                    logger.info('AV1 disabled!', {
    ...
    any () {
        DEFUSED_INDEXEDDB.forEach((name)=>{
            ...
            req.addEventListener('error', ()=>{
                logger.info('IndexedDB delete failed!', {
                    name
                });
            });
        });
